...
type GetCustomerProfileResponse struct {
	...
	Tenants       []*CustomerTenantMembership `protobuf:"bytes,2,rep,name=tenants,proto3" json:"tenants,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetCustomerProfileResponse) GetTenants() []*CustomerTenantMembership {
	if x != nil {
		return x.Tenants
	}
	return nil
...
const file_v1_api_proto_rawDesc = "" +
	...
	"\x19GetCustomerProfileRequest\"\x8e\x01\n" +
	"\x1aGetCustomerProfileResponse\x12/\n" +
	"\aprofile\x18\x01 \x01(\v2\x15.berberim.v1.CustomerR\aprofile\x12?\n" +
	"\atenants\x18\x02 \x03(\v2%.berberim.v1.CustomerTenantMembershipR\atenants\"Z\n" +
